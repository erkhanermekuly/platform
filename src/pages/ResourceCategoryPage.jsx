...
const RESOURCE_META = {
  documents: {
    ...
    intro: 'Быстрый доступ к основным требованиям и регламентам для дошкольных организаций.',
    loader: resourcesAPI.documents.list,
  },
  scenarios: {
    title: 'Передовой педагогический опыт',
    intro: 'Передовой педагогический опыт и лучшие практики в дошкольном образовании.',
